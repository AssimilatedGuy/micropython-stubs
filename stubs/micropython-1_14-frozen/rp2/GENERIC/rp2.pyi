...
class PIOASMEmit:
    ...
    wrap_used: bool = ...
    sideset_count: int = ...
    def __init__(self, *, out_init: Optional[Any]=..., set_init: Optional[Any]=..., sideset_init: Optional[Any]=..., in_shiftdir: int=..., out_shiftdir: int=..., autopush: bool=..., autopull: bool=..., push_thresh: int=..., pull_thresh: int=...) -> None: ...
    delay_max: int = ...
    sideset_opt: Any = ...
    pass_: Any = ...
    num_instr: int = ...
